...
This runs C<kde-config> and gathers it's output as a filehandle (C<KDE>).

 my $kde = <KDE>;

...sets $kde to the first line of C<KDE>.

 my $kdelibs = "$kde/lib";
 my $kdebin  = "$kde/bin";

It assumes you are using a *nix.
